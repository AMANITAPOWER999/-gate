...
💰 <b>Notional:</b> ${position["notional"]:.2f}
🔐 <b>Margin:</b> ${position["notional"]/5:.2f}
⚡ <b>Leverage:</b> x5
💳 <b>Balance:</b> ${balance:.2f}
...
⏱️ <b>Entry Time:</b> {datetime.fromisoformat(position["entry_time"]).strftime("%H:%M:%S")}
    ...
    def send_position_closed(self, trade, trade_number=1, balance=0, symbol="TOP1"):
        ...
        message = f"""
<b>{pnl_emoji} #{trade_number}</b>
<b>🔚 {side_text} {symbol_display}/USDT</b> (x5 leverage)

📍 <b>Entry Price:</b> ${trade["entry_price"]:.2f}
🎯 <b>Exit Price:</b> ${trade["exit_price"]:.2f}
📈 <b>Size (notional):</b> ${trade["size_base"]:.2f}
💰 <b>Notional:</b> ${trade["notional"]:.2f}
🔐 <b>Margin:</b> ${margin:.2f}
⚡ <b>Leverage:</b> x5

{profit_emoji} <b>P&L:</b> {pnl_sign}{trade["pnl"]:.2f} USDT
📊 <b>ROI:</b> {pnl_sign}{roi:.2f}%
💳 <b>Balance:</b> ${balance:.2f}

⏱️ <b>Exit Time:</b> {datetime.fromisoformat(trade["time"]).strftime("%H:%M:%S")}
